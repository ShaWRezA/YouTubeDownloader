...
| فیلد | توضیح | مثال |
|------|-------|------|
| **Single YouTube URL** | لینک ویدیوی یوتیوب | https://youtu.be/... |
| **Multiple URLs** | لینک چند ویدیو یوتیوب که با delimiter انتخاب شده جدا شدن | https://youtu.be/... , https://youtu.be/...|
| **Delimiter** | چیزی که با اون لینک ویدیو هارو جدا کردید )پیشفرض با , جدا میشن) | , (Comma) |
| **Type** | نوع دانلود (`video` یا `audio`) | video |
| **Quality** | کیفیت (144p تا 1080p برای ویدیو، 64kbps تا 320kbps برای صدا) | 720p |
| **Split threshold MB** | حداکثر حجم هر فایل (عدد 0 یعنی تقسیم نشه) گیت هاب محدودیت حجم 100 مگابایتی داره. | 90 |
| **Split Method** | چطور ویدیو به بخش های مختلف تقسیم میشه | zip, mp4 |
| **Download Folder** | فایل ها تو چه فولدری تو ریپو تون ذخیره بشه | downloads |
| **Parallel Downloads** | چند تا دانلود هم زمان انجام بشه (ترجیها روی 1 بمونه) | 1 |
...
> `نام_ویدیو_آیدی_کیفیت/نام_ویدیو_آیدی_کیفیت_بخش.mp4` یا `.mp3`
...
**طریقه اکسترکت کردن فایل های zip (باز کردن):**
...
برای فایل های mp4 فقط کافیه اون هارو به ترتیب تماشا کنید
---
...
اگر از این پروژه استفاده می‌کنید و براتون مفید بوده، می‌تونید از طریق لینک زیر از سازنده اصلی اون حمایت کنید:
